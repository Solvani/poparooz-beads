// Sharma, Wu, and Dalal supplementary CIEDE2000 test data (34 pairs):
// https://hajim.rochester.edu/ece/sites/gsharma/ciede2000/
// The values are test-only formula references, not production palette data.
export const CIEDE2000_REFERENCE_CASES = [
